...
<div id="school" class="tabcontent" sortable="true" align="center">
	<h3>School</h3>
...
$sql = "SELECT * FROM school JOIN faculty ON school.faculty_id=faculty.faculty_id";
...
<td align="center"><a id="<?php echo $row['school_id']; ?>" class="delete-link" href="#" title="Delete">
...
<script type="text/javascript">
	$(".delete-link").click(function()
	{
		...
		{
			$.post('del_scho.php', {'del_id':del_id}, function(data)
			{
				parent.fadeOut('slow');
			});	
		}
