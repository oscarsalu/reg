...
if(isset($_POST['grade'])){
  ...
  $upl = " UPDATE applicant SET school='$school',math='$math',english='$english',kiswahili='$kiswahili',biology='$biology',chemistry='$chemistry',physics='$physics',history='$history',geography='$geography',cre='$cre',home_science='$home_science',art='$art',agric='$agric',avaiation='$aviation',computer='$computer',metal='$metal',wood='$wood',building='$building',power='$power',electricity='$electricity',french='$french',german='$german',arabic='$arabic',music='$music',sign='$sign',business='$business',mean_grade='$mean_grade' WHERE user_refno='$ref'";

  $rees= $db->query($upl);
      if($rees){
                  echo "<script>alert('Your profile is updated!')</script>";
                  header("Location:course.php?success=" . urlencode(" Your grades have been successfully updated"));
              exit();
                  }else header("Location:update_form.php?err=" . urlencode("There is something wrong with the server try again later"));
              exit();
...
<h3><b>For subjects not done leave blank</b></h3>
<hr>
<div class="row">
    <div class="col-md-12 col-lg-12">
<form action="update_form.php" method="post" class="form-horizontal">
<div class="form-group">
<label class="col-sm-4">School Name</label>
<div class="col-sm-6">
<input type="text" name="skul" class="form-control" placeholder="Enter Your school name" required="required" value="<?php echo @$_SESSION['skul'];?>" >
</div>
</div>
<div class="form-group">
...
<button type="update" name="grade" class="btn btn-primary btn-lg">ADD GRADES</button>
</form>
</div>
<p><small>If you have added your grades and you want to continue please click <a href='course.php'>NEXT</a></small></p>
</div>
</div>
</div>
