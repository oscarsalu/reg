...
<!-- Editable Table - START -->
        ...
        while($row = $str->FETCH_ASSOC())
        {
            ?>
            <tr>
            <td><a id="<?php echo $row['program_id']; ?>" class="link" href="#" title="view"><?php echo $row['program_id']; ?></a></td>
            <td><a id="<?php echo $row['program_id']; ?>" class="link" href="#" title="view"><?php echo $row['intake_name']; ?></td>
            <td><a id="<?php echo $row['program_id']; ?>" class="link" href="#" title="view"><?php echo $row['academic_year']; ?></td>
