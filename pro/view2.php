...
$sql2 = "SELECT * FROM course_qualification JOIN cert_unit ON course_qualification.unit_code=cert_unit.unit_code JOIN cert_unit_grade ON course_qualification.score=cert_unit_grade.value JOIN certification ON course_qualification.cert_id=certification.cert_id where course_id=$id";
