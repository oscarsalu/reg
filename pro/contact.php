...
<nav class="navbar navbar-custom navbar-fixed-top" id="navbar" role="navigation">
  ...
  <a href="/project4/index.php" class="navbar-brand page-scroll" id="text1"><div id="image1"></div></a>
  </div>
  <!--toggle display ends-->
  ...
  <!--placing menu to the right-->
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <!-- Embedded Google Map -->
                <iframe width="100%" height="400px" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/maps?hl=en&amp;ie=UTF8&amp;ll=-1.3048035,36.8473969&amp;spn=-1.3048035,36.8473969&amp;t=m&amp;z=4&amp;output=embed"></iframe>
            </div>
            <!-- Contact Details Column -->
            <div class="col-md-4">
                <h3>Contact Details</h3>
                <p>
                    Technical University of Kenya<br>Nairobi, KE<br>
                </p>
                <p><i class="fa fa-phone"></i>
                    <abbr title="Phone">P</abbr>: (123) 456-7890</p>
                <p><i class="fa fa-envelope-o"></i>
                    <abbr title="Email">E</abbr>: <a href="oscarsalu@gmail.com">ADMIN</a>
                </p>
        ...
        <footer>
            <div class="row">
                <div class="col-lg-12">
                    <p>Copyright &copy; TECHNICAL UNIVERSITY OF KENYA</p>
                </div>
            </div>
        </footer>
